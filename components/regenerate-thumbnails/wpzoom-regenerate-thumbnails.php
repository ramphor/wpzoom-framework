            ...
            array(
                ...
                'strings' =>
                    array(
                        ...
                        'final_general_message' => sprintf(__('In the final step you have to go to the <a href="%s" target="_blank">Menus</a> page and configure your theme\'s menus. <p>You can find more instructions in this <br/><a href="https://www.wpzoom.com/docs/set-up-navigation-menus/" target="_blank">video tutorial</a> <em>(opens in new tab)</em>.</p>', 'wpzoom'), admin_url('nav-menus.php')),
