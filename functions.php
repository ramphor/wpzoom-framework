...
if(! function_exists('get_demo_xml_url')) {
    ...
    {
        $url = 'https://www.wpzoom.com/downloads/xml/' . str_replace(array('_', ' '), '-', strtolower(WPZOOM::$themeName)) . '.xml';
        ...
        if (current_theme_supports('wpz-multiple-demo-importer')) {
            ...
            $url = 'https://www.wpzoom.com/downloads/xml/' . str_replace(array('_', ' '), '-', strtolower(WPZOOM::$themeName)) . '-' . $selected . '.xml';
        }
